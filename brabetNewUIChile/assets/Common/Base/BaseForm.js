...
var o, i, a, r = cc._decorator,
    s = r.ccclass,
    c = r.property,
    l = require("./BaseComponent"),
    p = require("../Define/ColorDefine"),
    d = require("../Define/EffectPosTypeDefine"),
    h = require("../Define/ShareDefine"),
    u = require("./EventFunAdapter"),
    _ = require("../Define/GameEventDefine"),
    m = require("../../script/common/room_mode_tool");
(function (e) {
