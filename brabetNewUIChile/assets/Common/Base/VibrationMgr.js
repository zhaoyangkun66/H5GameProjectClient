...
var o = function(e) {
    function t() {
        ...
        t.Log("Init"),
        t.OpenVibration = app.LocalDataManager().GetConfigProperty("SysSetting"+ GameTypeGlobal, "ShieldShake"),
        t
    }
    return __extends(t, e),
    t.prototype.SetVibration = function(e) {
        this.OpenVibration = e,
        app.LocalDataManager().SetConfigProperty("SysSetting"+ GameTypeGlobal, "ShieldShake", e)
    }
    ,
