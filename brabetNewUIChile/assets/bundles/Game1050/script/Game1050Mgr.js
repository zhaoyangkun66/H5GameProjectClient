    ...
    , s = function (t) {
        ...
        return __extends(e, t),
            ...
            e.prototype.RequestGameBet = function () {
                ...
                if (isgoServer) {
                    app.HttpServerManager().SendHttpPack(r.Game1050HttpAPI.BetResult, t, false)
                }
                else {
                    if (Math.random() > 0) {
                        this.BetResultData = {
                        ...
                        // for (let index = 0; index < this.BetResultData.props.length; index++) {
                        //     for (const key in this.BetResultData.props[index].props) {
                        //         if (this.BetResultData.props[index].props[key] == 0) {
                        //             delete this.BetResultData.props[index].props[key]
                        //         }
                        //     }
                        // }
                    }
                            ...
                            "props": [
                                {
                                    ...
                                    "win_arrs": [{
                                        ...
                                        multiple: 10,//1倍或10倍
                                        win_odd: 5//3或 5或 8 或10 或25或 100或 250 
                                    }]
                                }
                            ],
            ...
            e.prototype.OnBetOneDayHistoryResult = function (t, send) {
                ...
                app.Client.OnEvent(r.Game1050HttpAPI.BetOneDayHistory, send)
            }
            ,
