    ...
    , h = function (e) {
        ...
        return __extends(t, e),
            ...
            t.prototype.setBalance = function () {
                ...
                if (this.salNumBonus) {
                    this.salNumBonus.string = e + app.ScoreUtil().toFixed(app.UserManager().GetUserInfo.bonus)
                }
            ...
            t.prototype.OnClick = function (e, t, n) {
                if ("btn_bonus" == e) {
                    app.FormManager().ShowForm(i.UINameDefine.UIBonusUnfrozen)
                }
                else if ("btn_withdraw" != e && "btn_arrow" != e)
                    if ("toggle" != e)
                        if ("toggle1" != e)
            ...
            __decorate([d(cc.Label)], t.prototype, "salNumBonus", undefined),
            __decorate([p], t)
    }(s.default);
n.default = h,
    module.exports = n
