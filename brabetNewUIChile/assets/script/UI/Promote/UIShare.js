                ...
                t.prototype.onShareData = function () {
                    ...
                    if (e) {
                        ...
                        null != n && "" != n && (o = app.i18n.t("UI.INVITE_0_main_5").replace("{count}", n),
                            cc.find("/box/lbl", this.node).getComponent(cc.Label).string = is2048Game ? app.i18n.t("UI.UIShare1") : "Usuários válidos: registre sucesso e receba bônus de novato de R$ 13"),
