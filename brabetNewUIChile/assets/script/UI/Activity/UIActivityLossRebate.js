        ...
        return __extends(t, e),
            ...
            t.prototype.onGetLossRebate = function (data) {
                ...
                if (data.vip == 10) {
                    ...
                    this.lbl_need.string = (data.vipExperienceMax - data.vipExperience) + app.i18n.t("UI.UIActivityLossRebate6")
                ...
                this.lbl_flsl.string = app.i18n.t("UI.UIActivityLossRebate4") + data.receiveGold + app.i18n.t("UI.UIActivityLossRebate5")
                this.lbl_time1.string = app.i18n.t("UI.UIActivityLossRebate3") + data.begin_timeAccumulated + '~' + data.end_timeAccumulated
                this.lbl_time2.string = app.i18n.t("UI.UIActivityLossRebate2") + data.begin_timeGet + '~' + data.end_timeGet
