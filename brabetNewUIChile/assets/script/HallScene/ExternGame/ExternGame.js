    ...
    , r = function () {
        ...
        return e.prototype.init = function (e, t) {
            ...
            e.prototype.initGameProgressView = function () {
                ...
                {
                    var o = document.createElement("div");
                    o.id = "gameProgressViewTitle"
                    // if (is2048Game) {
                    //     o.innerHTML = app.i18n.t("UI.UIGameProgressViewOther3")
                    //     o.style.fontSize = "31px"
                    // }
                    // else {
                    //     o.innerHTML = app.i18n.t("UI.UIGameProgressView3")
                ...
                }
                {
                    ...
                    if (is2048Game) {
                        if (GameTypeGlobal == 3) {
                            o.innerHTML = "Obtenga un cupón de retiro de <span style=\"color: #F5CC06;\">$100</span> por cada <span style=\"color: #F5CC06;\">$1,000</span> que apueste"
                        }
                        else {
                            o.innerHTML = "Receba um cupom de saque de <span style=\"color: #F5CC06;\">$ 100</c> para cada <span style=\"color: #F5CC06;\">$ 1.000</c> apostado"
                        }
                        // UI.UIGameProgressViewOtherHtml2,"Get a <span style=\""color: #F5CC06;\"">$100</c> withdrawal coupon for every <span style=\""color: #F5CC06;\"">$1,000</c> you wager",,,,,,,,,"Receba um cupom de saque de <span style=\""color: #F5CC06;\"">$ 100</c> para cada <span style=\""color: #F5CC06;\"">$ 1.000</c> apostado","Obtenga un cupón de retiro de <span style=\""color: #F5CC06;\"">$100</c> por cada <span style=\""color: #F5CC06;\"">$1,000</c> que apueste"
                ...
                {
                    var o = document.createElement("div");
                    o.id = "gameProgressViewdes"
                    // if (is2048Game) {
                    //     o.innerHTML = app.i18n.t("UI.UIGameProgressViewOther1")
                    //     o.style.fontSize = "22px"
                    // }
                    // else {
                    //     o.innerHTML = app.i18n.t("UI.UIGameProgressView1")
                    //     o.style.fontSize = "24px"
                    // }
                    o.style.position = "absolute"
            ...
            e.prototype.updataGameProgressView = function (data) {
                if (is2048Game) {
                    document.getElementById("gameProgressViewTitle").innerHTML = app.i18n.t("UI.UIGameProgressViewOther3")
                    document.getElementById("gameProgressViewTitle").style.fontSize = "31px"
                }
                else {
                    document.getElementById("gameProgressViewTitle").innerHTML = app.i18n.t("UI.UIGameProgressView3")
                    document.getElementById("gameProgressViewTitle").style.fontSize = "43px"
                }
                if (is2048Game) {
                    document.getElementById("gameProgressViewdes").innerHTML = app.i18n.t("UI.UIGameProgressViewOther1")
                    document.getElementById("gameProgressViewdes").style.fontSize = "22px"
                }
                else {
                    document.getElementById("gameProgressViewdes").innerHTML = app.i18n.t("UI.UIGameProgressView1")
                    document.getElementById("gameProgressViewdes").style.fontSize = "24px"
                }
                ...
                if (data.betGold >= data.needBetGold) {//data.receiveGold > 0 暂时
                    ...
                    if (is2048Game) {
                        document.getElementById("btnGetLabel").innerHTML = "$ " + data.receiveGold
                    }
                    else {
                    ...
                    if (is2048Game) {
                        document.getElementById("btnGetLabelView").innerHTML = "$ " + data.receiveGold
                    }
                    else {
                    ...
                    document.getElementById("btnGetLabel").innerHTML = app.i18n.t("UI.UIGameProgressView4")
                    ...
                    document.getElementById("btnGetLabelView").innerHTML = app.i18n.t("UI.UIGameProgressView4")
            ...
            e.prototype.initUIGoldReward = function () {
                ...
                t.style.position = "absolute",
                    ...
                    e.appendChild(t);
                var o = document.createElement("div");
                o.id = "UIGoldRewardTitle"
                // if (GameTypeGlobal == 3) {
                //     o.innerHTML = app.i18n.t("UI.UIWithdrawalCoupon1")
                // }
                // else {
                //     o.innerHTML = app.i18n.t("UI_Reward")
                // }
                o.style.position = "absolute",
                    o.style.left = "50%",
                    o.style.top = "59.59px",
                ...
                var s = document.createElement("div");
                s.id = "UIGoldRewardRewardDes"
               // s.innerHTML = app.i18n.t("UI_GoldReward") // "Clique na tela para continuar",
                s.style.position = "absolute",
            ...
            e.prototype.openUIGoldReward = function (data) {
                ...
                if (GameTypeGlobal == 3) {
                    document.getElementById("UIGoldRewardTitle").innerHTML = app.i18n.t("UI.UIWithdrawalCoupon1")
                }
                else {
                    document.getElementById("UIGoldRewardTitle").innerHTML = app.i18n.t("UI_Reward")
                }
                document.getElementById("UIGoldRewardRewardDes").innerHTML = app.i18n.t("UI_GoldReward")
