        ...
        function (t) {
            ...
            return __extends(e, t),
                e.prototype.OnCreateInit = function () {
                    var t = this;
                    this.JS_Name = "UIGame1053Bigwin",
                        this.label_num = this.GetWndComponent("label_numBG/label_num", cc.Label),
                        this.RegEvent(o.GameCommonEventType.CloseBigWin, this.OnCloseSelfEvent)
                    this.bgSpAnimNode = this.GetWndComponent("win", sp.Skeleton),
                        this.bgSpAnimNode.setCompleteListener(function (e) {
                            switch (e.animation.name) {
                                case a.Game1053BigWinName.bigwin_act:
                                    t.bgSpAnimNode.setAnimation(0, a.Game1053BigWinName.bigwin_loop, true);
                                    break;
                                case a.Game1053BigWinName.megawin_act:
                                    t.bgSpAnimNode.setAnimation(0, a.Game1053BigWinName.megawin_loop, true);
                                    break;
                                case a.Game1053BigWinName.supermegawin_act:
                                    t.bgSpAnimNode.setAnimation(0, a.Game1053BigWinName.supermegawin_loop, true)
                            }
                        })
                }
                ,
                e.prototype.OnShow = function () {
                    ...
                    "pt-pt" == i ? n = "Pu" : "es-es" == i ? n = "Es" : "id-id" == i && (n = "Id"),
                        ...
                        this.bgSpAnimNode.setAnimation(0, a.Game1053BigWinName.bigwin_act, false),
                        ...
                        app.SoundManager().PlayBackMusic("game1053_win", true),
                        this.isUpdate = true,
                        this.currentValue = 0,
                ...
                e.prototype.updateValue = function () {
                    ...
                    e < this.phaseDurationList[0] ? (t = e / this.phaseDurationList[0],
                        ...
                        this.IsPlayStates[0] || (this.IsPlayStates[0] = 1,
                            app.SoundManager().PlaySound("game1053_bigt"))) : e < this.phaseDurationList[0] + this.phaseDurationList[1] ? (t = (e - this.phaseDurationList[0]) / this.phaseDurationList[1],
                                this.currentValue = this.phase1Target + t * (this.phase2Target - this.phase1Target),
                                this.IsPlayStates[1] || (this.IsPlayStates[1] = 1,
                                    app.SoundManager().PlaySound("game1053_bigt"))) : (t = Math.min((e - this.phaseDurationList[0] - this.phaseDurationList[1]) / this.phaseDurationList[2], 1),
                                        this.currentValue = this.phase2Target + t * (this.new_gold - this.phase2Target),
                                        this.IsPlayStates[2] || (this.IsPlayStates[2] = 1,
                                            app.SoundManager().PlaySound("game1053_bigt"))),
                ...
                e.prototype.updateInfo = function () {
                    ...
                    this.old_gold >= this.new_gold && (this.old_gold = this.new_gold,
                        this.isUpdate && (this.isUpdate = false,
                            app.SoundManager().PlayBackMusic("game1053_final", false),
                    ...
                    this.playkey != e && (this.playkey = e,
                        0 == this.playkey ? (app.ComUtil().PlayAnim(this.node, "bigwin_act_light"), this.bgSpAnimNode.setAnimation(0, a.Game1053BigWinName.bigwin_act, false))
                            : 1 == this.playkey ? (app.ComUtil().PlayAnim(this.node, "megawin_act_light"), this.bgSpAnimNode.setAnimation(0, a.Game1053BigWinName.megawin_act, false))
                                : 2 == this.playkey && (app.ComUtil().PlayAnim(this.node, "supermegawin_act_light"), this.bgSpAnimNode.setAnimation(0, a.Game1053BigWinName.supermegawin_act, false))
                    )
                }
                ,
