        ...
        function (t) {
            ...
            return __extends(e, t),
                e.prototype.OnCreateInit = function () {
                    this.JS_Name = "Game_1052Rules"
                }
                ,
                e.prototype.OnLoad = function () {
                    this.GeneralRules2 = this.GetWndComponent("scrollview/view/content/GeneralRules2", cc.Label)
                    let TitleDesc2 = this.GeneralRules2.string.replace("%{minChip}", app.GameBetCommonMgr().betAmountConfig[app.GameBetCommonMgr().betAmountConfig.length - 1])
                    ...
                    this.label_InGameCurrency.string = this.label_InGameCurrency.string.replace("%{configuredValue}", app.GameConfigManager().GetCurrency);
                ...
                ,
                __decorate([r, s("UI/prefab/Game_1052Rules")], e)
        }(n.default));
i.default = l,
    module.exports = i
