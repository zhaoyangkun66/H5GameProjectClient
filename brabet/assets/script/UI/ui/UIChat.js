        ...
        function (e) {
            ...
            return __extends(t, e),
                t.prototype.OnCreateInit = function () {
                    this.RegEvent(i.GameEventDefine.UIChatUpdateTopWidget, this.updateTopWidget)
                }
                ,
                t.prototype.updateTopWidget = function () {
                    if (app.ComTool().H5Platform()) {
                        if (app.Client.GetDownload().active == true) {
                            this.GetWndComponent("right/connect", cc.Widget).top = 220
                           // this.GetWndComponent("right/connect", cc.Widget).y = 527 + 80
                        }
                        else {
                            this.GetWndComponent("right/connect", cc.Widget).top = 140
                           // this.GetWndComponent("right/connect", cc.Widget).y = 527 + 80
                        }
                    }
                }
