                        ...
                        this.CheckPercentNode.active = h,
                            ...
                            a.goods.forEach(function (e) {
                                        ...
                                        t.SetShopNumNodeData(Number(e)));
                                {
                                    ...
                                    if (maskBouns) {
                                        if (ChannelTemp.send_bonus_ratio > 0) {
                                            maskBouns.active = true
                                        } else {
                                            maskBouns.active = false
                                        }
                                        cc.find("lb_num", maskBouns).getComponent(cc.Label).string = "+" + (ChannelTemp.send_bonus_ratio * e) + "Bônus"
                                    }
                                }
                    ...
                    if (t) {
                        if (t.payURL) {
                            if (t.inout == 1) {
                                ...
                                if (is2048Game) {
                                    app.ConfirmManager().ShowConfirm(ShareDefine.ConfirmType.ConfirmYNPagamento, "Após a conclusão do depósito, o saldo será atualizado em cerca de 1 a 3 minutos, no máximo", null, function () {
                                        cc.sys.openURL(t.payURL)
                                    })
                                }
                                else {
