    ...
    , d = function (e) {
        ...
        return __extends(t, e),
            t.prototype.OnLoadInit = function () {
                app.HttpServerManager().RegNetPack(a.HttpAPI.GET_YesterdayLotteryDraw, this.OnGetLatestRounds, this),
            ...
            t.prototype.RequestList = function () {
                // let dateXXX = []
                // for (let index = 0; index < 338; index++) {
                //     dateXXX.push({
                //         "id": index,
                ...
                this.NewRoundsData && 0 != this.NewRoundsData.length || this.isRequest || (this.setIsRequest(true),
                    ...
                    app.HttpServerManager().SendHttpPack(a.HttpAPI.GET_YesterdayLotteryDraw, {
            ...
            t.prototype.itemInfo = function (e, t) {
                ...
                this.GetWndNode("lotteryPrizes", e).getComponent(cc.Label).string = app.GameConfigManager().GetCurrency + " " + t.lotteryPrizes
                this.GetWndNode("totalBonus", e).getComponent(cc.Label).string = app.GameConfigManager().GetCurrency + " " + t.totalBonus
            }
            ,
