...
function(e) {
    ...
    t.prototype.OnShow = function() {
        ...
        app.GameConfigManager().IsExperienceServer || app.FormManager().FormVisible(s.UINameDefine.UIDownAndSevice, true)
    }
    ,
    ...
    t.prototype.LoadHallSuccess = function() {
        if (app.FormManager().FormVisible(s.UINameDefine.UIDownAndSevice, true),
        2 == app.GameConfigManager().GetGameConfig().is_up && app.ComTool().AndroidHybirdPlatform()) {
