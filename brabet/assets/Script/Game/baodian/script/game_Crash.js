            ...
            e.prototype.onLoad = function () {
                t.prototype.onLoad.call(this),
                    ...
                    app.ComTool().H5Platform() ?
                        ...
                        : (this.btnSecond = this.GetWndNode("content/content/Manual/top/btnSecond", this.node),
                            ...
                            this.autoRoundsNode = [this.GetWndComponent("normal/normal/autoplay/Rounds/Apostas", cc.EditBox, this.panelManual), this.GetWndComponent("normal/normal/autoplay/Rounds/Apostas", cc.EditBox, this.panelManual2)],
                            this.BetBtnOne = [],
                            this.BetBtnTwo = []),
                ...
                if (!e.getChildByName("checkmark").active) {
                    ...
                    for (this.isAutoView = t,
                        ...
                        this.autoPlayNode[a].active = t,
                            ...
                            this.manualScaleInput[a].node.parent.parent.active = !t,//app.ComTool().H5Platform() ? this.manualScaleInput[a].node.parent.parent.active = !t : this.manualScaleInput[a].node.parent.active = !t,
