window.__require = function t(e, n, o) {
    ...
    MinesDefine: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "26dc2Hg+TVOgp5aXgGMU0U/", "MinesDefine"),
    ...
    , {}],
    MinesGame: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "a87c8uKTgRPmoT8ovKMMUX6", "MinesGame"),
        Object.defineProperty(n, "__esModule", {
            value: !0
        });
        var o = require("../../../Common/Define/UINameDefine")
          ...
          , m = function(t) {
            ...
            e.prototype.OnShow = function() {
                ...
                this.onBetGoldNum(this.GameBetGold, null, !1),
            ...
            e.prototype.onInitialization = function() {
                ...
                this.betBtn.active = !0,
                this.AutoBetBtn.active = !1,
                this.minesNumNode.active = !1,
            ...
            e.prototype.OnClick = function(t, e, n) {
                "Autobtn" != t ? "page_left" != t ? "page_right" != t ? "help" != t && "btn_help" != t ? "toggle1" != t && "toggle2" != t ? "btn_mines_hide" != t ? "btn_minesCount" != t ? "toggle2_perder" != t && "toggle1_perder" != t && "toggle1_vencer" != t && "toggle2_vencer" != t ? app.UserManager().GetIsOfficialPopup() || ("betbtn" != t ? "Autobetbtn" != t ? "btn" != t && "btn2" != t ? "mines_btn" != t ? "btn_mines_show" != t || this.btnMinesNumShow() : this.btnQuickSelectionMines(n) : this.btnInputValue(n) : this.btnAutoBet(e) : this.btnNetBet()) : this.autoTextChanged() : this.btnSetMinesNum(e) : this.btnMinesNumHide() : this.onToggle(e) : this.onOpenHelp() : this.btnAddBetScalePage() : this.btnReduceBetScalePage() : this.btnAutoPick()
            }
            ,
            ...
            e.prototype.btnAutoBet = function(t) {
                0 != this.autoBetDataInfo.selectData.length ? t && this.autoBetStatus == u.GameStatus.GAME_START ? this.setAutoBetFalse() : this.gameStatus != u.GameStatus.GAME_END && this.onRequestBet() : this.onMinesGzAnim(!0)
            }
            ,
            ...
            e.prototype.OnMinesOpenPos = function(t) {
                var e = t.data
                  , n = t.senData;
                if (this.guide.active && this.onMinesGzAnim(!1),
                !this.isAutoBet) {
            ...
            e.prototype.onMinesGzStatus = function(t) {
                ...
                for (var o = 0; o < n.length; o++) {
                    var i = n[o]
                      , a = i.children[0];
                    a && a.active && 1 == a.scale && !t ? (i.children[0].active = !0,
                    i.children[0].scale = 1,
                    i.children[1].active = !1) : i.getComponent(cc.Animation).play("close")
                }
            }
            ,
                ...
                if (0 != this.oddsData.length) {
                    ...
                    for (var n = this.pageItem.childrenCount, o = 0, i = Math.ceil(this.oddsData.length / n), a = 0; a < i; a++) {
                        ...
                        s.children.forEach(function(e) {
                            t.oddsData[o] ? (e.active = !0,
                            e.children[0].getComponent(cc.Label).string = t.oddsData[o].rate + "x",
                            t.MinesTool.getMinesNodeCol(e, t.NodeColorList[4])) : e.active = !1,
                            o++
                        }),
                        s.active = !0
                    }
            ...
            e.prototype.onEnabled = function() {
                ...
                this.autoFailAddNumInput.node.parent.resumeSystemEvents(t)) : (this.manualBaseInput.node.parent.pauseSystemEvents(!0),
                this.autoMaxRoundInput.node.parent.pauseSystemEvents(!0),
                this.autoWinNumInput.node.parent.pauseSystemEvents(!0),
                this.autoFailNumInput.node.parent.pauseSystemEvents(!0),
                this.autoWinAddNumInput.node.parent.pauseSystemEvents(!0),
                this.autoFailAddNumInput.node.parent.pauseSystemEvents(!0)) : (this.manualBaseInput.getComponent(cc.EditBox).enabled = t,
    ...
    , {
        ...
        "../../../script/common_hall/GameBaseForm": void 0,
        "../script/MinesTool": "MinesTool",
        "./MinesDefine": "MinesDefine",
        "./game550Mgr": "game550Mgr"
    }],
    MinesHistory: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "b4854nPH35BrKoNymJh48V1", "MinesHistory"),
        Object.defineProperty(n, "__esModule", {
            value: !0
        });
        ...
        function(t) {
            ...
            e.prototype.itemInfo = function(e, n) {
                ...
                cc.find("content/id/label", e).getComponent(cc.Label).string = n.begin_time + "",
                cc.find("content/mines/label", e).getComponent(cc.Label).string = n.lnum + "",
                cc.find("content/bets/label", e).getComponent(cc.Label).string = Number(n.bet_gold).toFixed(2),
                cc.find("content/time/label", e).getComponent(cc.Label).string = n.create_time;
                var o = cc.find("content/status/label", e);
    ...
    , {
        "../../../script/common_hall/BaseSingleGameHistory": void 0
    }],
    MinesTool: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "703f1fueTJCn42z1x5Rr69d", "MinesTool"),
        Object.defineProperty(n, "__esModule", {
            value: !0
        }),
        n.MinesTool = void 0;
        var o, i = require("../../../Common/Bundle/BundleConfig"), a = require("../../../Common/Bundle/BundleManager"), s = require("../../../Common/Define/ShareDefine"), u = require("./MinesDefine"), l = (o = cc.Node,
        __extends(function() {
    ...
    game550Mgr: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "9c237KEXFBEOrDN0lGGJB+8", "game550Mgr"),
        Object.defineProperty(n, "__esModule", {
            value: !0
        }),
        n.game550Mgr = void 0;
        var o = require("../../../Common/Base/Singleton")
          ...
          , a = function(t) {
            ...
            ,
            e.prototype.onRequestGame = function(t) {
                app.HttpServerManager().SendHttpPack(i.Game550HttpAPI.MINES_OPEN_POS, t)
            }
            ,
    ...
    , {
        "../../../Common/Base/Singleton": void 0,
        "./MinesDefine": "MinesDefine"
    }]
}, {}, ["MinesDefine", "MinesGame", "MinesHistory", "MinesTool", "game550Mgr"]);
