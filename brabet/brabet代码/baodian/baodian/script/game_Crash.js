...
var r = require("../../../Common/Component/NodePool")
    , l = require("../../../Common/Define/GameEventDefine")
    , u = require("../../../Common/Define/GameHttpDefine")
    , h = require("../../../Common/Define/UINameDefine")
    , c = require("../../../Common/Bundle/BundleConfig")
    , p = require("../../../Common/Net/BaseDefine")
    , d = require("../../../script/common_hall/hall_view")
    , m = require("./BDDefine")
    , B = cc._decorator
    , g = B.ccclass
    , S = B.property
    , f = function (t) {
        ...
        return __extends(e, t),
            e.prototype.onLoad = function () {
                t.prototype.onLoad.call(this),
                    ...
                    app.ComTool().H5Platform() ?
                        (this.btnSecond = this.GetWndNode("layout/scrollview/view/btnSecond", this.panelManual),
                            ...
                            this.manualBaseInput = [this.GetWndComponent("layout/Quantia/Quantia/editbox_xsje/TEXT_LABEL", cc.Label, this.panelManual), this.GetWndComponent("Quantia/Quantia/editbox_xsje/TEXT_LABEL", cc.Label, this.panelManual2)],
                            this.manualScaleInput = [this.GetWndComponent("layout/Sqque/editbox_xsje/TEXT_LABEL", cc.Label, this.panelManual), this.GetWndComponent("Sqque/editbox_xsje/TEXT_LABEL", cc.Label, this.panelManual2)],
                            this.autoScaleInput = [this.GetWndComponent("layout/autoplay/Sqque/editbox_xsje/TEXT_LABEL", cc.Label, this.panelManual), this.GetWndComponent("autoplay/Sqque/editbox_xsje/TEXT_LABEL", cc.Label, this.panelManual2)],
                            this.autoRoundsNode = [this.GetWndComponent("layout/autoplay/Rounds/Apostas/TEXT_LABEL", cc.Label, this.panelManual), this.GetWndComponent("autoplay/Rounds/Apostas/TEXT_LABEL", cc.Label, this.panelManual2)],
                            ...
                            this.BetBtnTwo = [this.GetWndNode("Quantia/btn_SManual1", this.panelManual2), this.GetWndNode("Quantia/btn_SManual10", this.panelManual2)])
                        : (this.btnSecond = this.GetWndNode("layout/scrollview/view/btnSecond", this.panelManual),
                            this.btnHide = this.GetWndNode("layout/scrollview/view/btnHide", this.panelManual),
                            this.btnManual = this.GetWndNode("layout/scrollview/view/content/toggleContainer/btnManual", this.panelManual),
                            this.btnAuto = this.GetWndNode("layout/scrollview/view/content/toggleContainer/btnAuto", this.panelManual),
                            this.manualBaseInput = [this.GetWndComponent("layout/Quantia/Quantia/editbox_xsje", cc.EditBox, this.panelManual), this.GetWndComponent("Quantia/Quantia/editbox_xsje", cc.EditBox, this.panelManual2)],
                            this.manualScaleInput = [this.GetWndComponent("layout/Sqque/editbox_xsje", cc.EditBox, this.panelManual), this.GetWndComponent("Sqque/editbox_xsje", cc.EditBox, this.panelManual2)],
                            this.autoScaleInput = [this.GetWndComponent("layout/autoplay/Sqque/editbox_xsje", cc.EditBox, this.panelManual), this.GetWndComponent("autoplay/Sqque/editbox_xsje", cc.EditBox, this.panelManual2)],
                            this.autoRoundsNode = [this.GetWndComponent("layout/autoplay/Rounds/Apostas", cc.EditBox, this.panelManual), this.GetWndComponent("autoplay/Rounds/Apostas", cc.EditBox, this.panelManual2)],
                            this.redWarnScale = [this.GetWndNode("layout/Sqque/red", this.panelManual), this.GetWndNode("Sqque/red", this.panelManual2)],
                            this.manualBetBtn = [this.GetWndNode("layout/Sqque/manualBetBtn", this.panelManual), this.GetWndNode("Sqque/manualBetBtn", this.panelManual2)],
                            this.autoBetBtn = [this.GetWndNode("layout/auto/autoBetBtn", this.panelManual), this.GetWndNode("auto/autoBetBtn", this.panelManual2)],
                            this.autoPlayNode = [this.GetWndNode("layout/autoplay", this.panelManual), this.GetWndNode("autoplay", this.panelManual2)],
                            ...
                            this.BetBtnOne = [this.GetWndNode("layout/Quantia/btn_Manual1", this.panelManual), this.GetWndNode("layout/Quantia/btn_Manual10", this.panelManual)],
                            this.BetBtnTwo = [this.GetWndNode("Quantia/btn_SManual1", this.panelManual2), this.GetWndNode("Quantia/btn_SManual10", this.panelManual2)])
                this.panelManual.active = true,
                    this.panelManual2.active = false,
                    this.btnSecond.active = false,
                    ...
                    this.rockAni.active = false,
                    this.boomPlayerName.active = false,
                    this.initGameInfo(),
                    this.OnBtnCheckMarkView(false),
                    this.BtnBoomHide(),
                    this.myGoldNum(app.UserManager().GetUserInfo.gold),
                    this.hisScoreNode.active = false,
                    this.rankingNode.active = false;
                for (var e = 0; e < 2; e++)
                    this.redWarnScale[e].active = false,
            ...
            e.prototype.setPlayMusic = function () {
                app.SoundManager().isMusicPlaying || (app.SoundManager().GetBackMusicSetting ? app.SoundManager().PlayBackMusic("bd_Bgm", true) : app.SoundManager().StopBackMusic())
            }
            ,
            ...
            e.prototype.OnShow = function () {
                ...
                this.setPlayMusic(),
                    ...
                    this.OnRequestHistory(true);
                for (var o = 0; o < 2; o++)
                    this.setAutoBetBtnStr(app.i18n.t("Bao_Dian_CanAuto"), o),
                        this.GetBetGoldAdd(this.GameBetGold, "" + o, false)
            }
            ,
                                            ...
                                            if ("ranking" != t)
                                                if ("btnManual" != t)
                                                    if ("btnAuto" != t)
                                                        ...
                                                        this.OnToggleView(true, e);
                                                else
                                                    this.OnToggleView(false, e);
                                            else
                                                this.bottomRanking();
                                        else
                                            this.bottomHisScore();
            ...
            e.prototype.startAutoBet = function (t) {
                ...
                this.checkLimitBetNum() || (this.BetStatus[0].playerStatus != o.BETED && this.BetStatus[1].playerStatus != o.BETED ? this.autoBetStatus[e] ? this.OnStopAutoBet(e) : (this.autoTextChanged(null, null, t),
                    ...
                    this.isGoldIn(this.preBetNum[e]) || (this.preBetNum[e] < 1 || this.betScaleNum[e] < 1.01 ? this.Log("BaodianBetError:%s \u7206\u7387:%s", this.preBetNum, this.betScaleNum) : (this.BetStatus[e].autoStatus = this.BetStatus[e].autoStatus == o.BETED ? o.BETED : o.PRE_BET,
                        ...
                        this.autoBetStatus[e] = true,
                        this.setBetPatternID(e, false),
                    ...
                    if (this.OnBtnCheckMarkView(t),
                        ...
                        for (a = 0; a < 2; a++)
                            this.BetStatus[a].playerStatus == o.PRE_BET && (this.setManualStatus(a, o.DEFAULT, "Bao_Dian_sposta", 1),
                                this.preBetNum[a] = 0,
                                this.setBetPatternID(a, true));
                    else
                        for (var a = 0; a < 2; a++)
                            this.autoBetStatus[a] && (this.setAutoBetFalse(a),
                                this.BetStatus[a].autoStatus != o.BETED && this.setBetPatternID(a, true)),
            ...
            e.prototype.secondNodeShow = function (t) {
                this.panelManual2.active = t,
                    ...
                    this.panelManual2.active ? this.onBetGold(this.GameBetGold, 1, false) : (this.manualBaseInput[1].string = "",
                ...
                if (1 == e.type) {
                    if (this.myScoreView.children.forEach(function (t, e) {
                        ...
                        n.forEach(function (t, e) {
                            ...
                            n || ((n = cc.instantiate(a.myScoreView.children[0])).parent = a.myScoreView),
                                n.active = true,
                                a.GetWndNode("id", n).getChildByName("label").getComponent(cc.Label).string = t.scoreid + "",
                                a.GetWndNode("boombet", n).getChildByName("label").getComponent(cc.Label).string = t.boom + "/" + t.bet,
                                a.GetWndNode("time", n).getChildByName("label").getComponent(cc.Label).string = t.time;
                            var o = a.GetWndNode("status", n).getChildByName("label")
                            ...
                            o.getComponent(cc.Label).string = i + "",
                                ...
                                a.GetWndNode("sysboom", n).getChildByName("label").getComponent(cc.Label).string = t.endScale + ""
                        })
                    }
                } else {
                    var l = []
                    ...
                    this.Log("history ", t),
                        this.isOnloadGame && (this.parseSysHist(l.reverse()),
                            this.isOnloadGame = false),
                        this.hisScoreView.children.forEach(function (t, e) {
                            e >= 0 && (t.active = false)
                        }),
                        u.forEach(function (t, e) {
                            var n = a.hisScoreView.children[e];
                            n || ((n = cc.instantiate(a.hisScoreView.children[0])).parent = a.hisScoreView),
                                n.active = true;
                            var o = a.GetWndNode("bg_id/label", n)
                                , i = a.GetWndNode("bg_date/label", n)
                                , s = a.GetWndNode("bg_scale/label", n);
            ...
            e.prototype.betScaleChange = function (t, e, a) {
                ...
                this.redWarnScale[Number(a)].active = false,
                    Number(n) < 1.01 && this.isAutoView && (this.redWarnScale[Number(a)].active = true),
                    this.endInputText(a)
            }
            ,
            ...
            e.prototype.resHallInfo = function (t) {
                ...
                for (a[1] && this.secondNodeShow(true),
                    e = 0; e < 2; e++)
            ...
            e.prototype.gameBet = function () {
                t.prototype.gameBet.call(this),
                    ...
                    this.tickTimeLabel.active = true,
                    this.canBetTimeDown = true,
                    this.hideTheWinPanel(0);
            ...
            e.prototype.playRockWith = function (t) {
                ...
                var a = app.ComTool().H5Platform() ? "rock" : "rock"//"rock_web";
            ...
            e.prototype.gameResultStuats = function (t) {
                (this.BetStatus[t].playerStatus != o.PRE_BET && !this.isAutoView || this.BetStatus[t].autoStatus != o.PRE_BET && this.isAutoView) && (this.isAutoView || this.setBetPatternID(t, true),
                    this.preBetNum[t] = 0,
            ...
            e.prototype.addHistoryScale = function (t) {
                ...
                a.color = t >= 2 ? cc.Color.BLACK.fromHEX(this.btnColorList[6]) : cc.Color.BLACK.fromHEX(this.btnColorList[3]),
                    ...
                    a.getChildByName("new").active = true,
                    a.parent = this.historyCont;
                var n = app.ComTool().H5Platform() ? 759 : 759// 970;
            ...
            e.prototype.showCurScale = function (t) {
                ...
                for (var e = t.toFixed(2).length - 1, a = this.btnBoom.childrenCount - 2; a >= 0; a--) {
                    ...
                    e--,
                        n ? (this.btnBoom.children[a].active = true,
                            this.btnBoom.children[a].getComponent(cc.Label).string = n) : this.btnBoom.children[a].active = false
                }
            }
            ,
            e.prototype.BtnBoomHide = function () {
                this.btnBoom && (this.btnBoom.active = false,
                    this.btnBoom.children[0].active = false,
                    this.btnBoom.children[1].active = false)
            }
            ,
            e.prototype.setProgressNum = function (t) {
                this.tickTimeLabel.getChildByName("time").getChildByName("num").getComponent(cc.Label).string = t.toFixed(0),
                    this.playTimeAnim(t, this.tickTimeLabel.getChildByName("time").getChildByName("num"))
            }
            ,
            e.prototype.tickTimeHide = function () {
                this.tickTimeLabel.active = false,
                ...
                this.isTimePlay = false,
                    this.isTimePlay1 = false
            }
            ,
            e.prototype.playTimeAnim = function (t, e) {
                t < 4 && !this.isTimePlay1 && (this.isTimePlay1 = true,
                    ...
                    t <= 3.5 && this.canBetTimeDown && !this.isTimePlay && (this.isTimePlay = true,
                        cc.tween(e).to(.5, {
                            scale: 1.5
                        }).to(.5, {
                            scale: 1
