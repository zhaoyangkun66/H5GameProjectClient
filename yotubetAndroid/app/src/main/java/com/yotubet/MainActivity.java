...
public class MainActivity extends AppCompatActivity {
   ...
   // String url = "https://zhaoyangkun66.github.io/test/indexF.html?appId=3655106758067676";
    String urlYM = "www.sol555.com";
    String url = "https://www.sol555.com/?channel_id=apk";
    ...
    public class myWebViewclient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            if ("zhaoyangkun66.github.io".equals(request.getUrl().getHost())||urlYM.equals(request.getUrl().getHost())) {
