...
# static fields
.field public static உ:Landroid/animation/LayoutTransition;

.field public static ḓ:Z

.field public static 㚬:Z

.field public static 㺴:Ljava/lang/reflect/Method;

.field public static 䂻:Ljava/lang/reflect/Field;


# direct methods
.method public static உ(Landroid/animation/LayoutTransition;)V
    .locals 7

    sget-boolean v0, L㚬/ḙ/ㄬ;->ḓ:Z
    ...
    sput-object v4, L㚬/ḙ/ㄬ;->㺴:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v0, L㚬/ḙ/ㄬ;->ḓ:Z

    :cond_0
    sget-object v0, L㚬/ḙ/ㄬ;->㺴:Ljava/lang/reflect/Method;
...
.method public static 䂻(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v0, L㚬/ḙ/ㄬ;->உ:Landroid/animation/LayoutTransition;
    ...
    new-instance v0, L㚬/ḙ/ㄬ$உ;

    invoke-direct {v0}, L㚬/ḙ/ㄬ$உ;-><init>()V

    sput-object v0, L㚬/ḙ/ㄬ;->உ:Landroid/animation/LayoutTransition;
    ...
    invoke-static {p1}, L㚬/ḙ/ㄬ;->உ(Landroid/animation/LayoutTransition;)V
    ...
    :cond_2
    sget-object p1, L㚬/ḙ/ㄬ;->உ:Landroid/animation/LayoutTransition;
    ...
    sput-object p1, L㚬/ḙ/ㄬ;->䂻:Ljava/lang/reflect/Field;
    ...
    :goto_0
    sput-boolean v1, L㚬/ḙ/ㄬ;->㚬:Z

    :cond_4
    sget-object p1, L㚬/ḙ/ㄬ;->䂻:Ljava/lang/reflect/Field;
    ...
    :try_start_2
    sget-object v1, L㚬/ḙ/ㄬ;->䂻:Ljava/lang/reflect/Field;
