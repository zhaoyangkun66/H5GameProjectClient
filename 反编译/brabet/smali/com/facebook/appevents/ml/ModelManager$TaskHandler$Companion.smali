...
.method private final deleteOldFiles(Ljava/lang/String;I)V
    ...
    invoke-static {v5, p1, v2, v6, v7}, Lḓ/ḙ/ཇ;->ཇ(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z

    move-result v8

    if-eqz v8, :cond_3

    invoke-static {v5, p2, v2, v6, v7}, Lḓ/ḙ/ཇ;->ཇ(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
...
.method private static final execute$lambda-1(Ljava/util/List;Ljava/io/File;)V
    ...
    new-instance v4, L㺴/உ/ม/ಋ/㚬;

    invoke-direct {v4, v0, p1}, L㺴/உ/ม/ಋ/㚬;-><init>(Lcom/facebook/appevents/ml/ModelManager$TaskHandler;Lcom/facebook/appevents/ml/Model;)V
...
.method public static synthetic உ(Ljava/util/List;Ljava/io/File;)V
    .locals 0
...
.method public static synthetic 䂻(Lcom/facebook/appevents/ml/ModelManager$TaskHandler;Lcom/facebook/appevents/ml/Model;Ljava/io/File;)V
    .locals 0
...
.method public final build(Lorg/json/JSONObject;)Lcom/facebook/appevents/ml/ModelManager$TaskHandler;
    ...
    invoke-static {v4, v1}, Lḓ/ᓭ/㺴/ಫ;->㚬(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public final execute(Lcom/facebook/appevents/ml/ModelManager$TaskHandler;Ljava/util/List;)V
    ...
    new-instance v1, L㺴/உ/ม/ಋ/䂻;

    invoke-direct {v1, p2}, L㺴/உ/ม/ಋ/䂻;-><init>(Ljava/util/List;)V
