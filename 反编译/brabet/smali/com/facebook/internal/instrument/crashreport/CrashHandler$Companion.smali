...
.method private final sendExceptionReports()V
    ...
    :cond_3
    sget-object v1, L㺴/உ/ㄬ/㲧/ㄏ/䂻;->உ:L㺴/உ/ㄬ/㲧/ㄏ/䂻;

    invoke-static {v0, v1}, Lḓ/㹖/㭲;->ർ(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
    ...
    invoke-static {v3, v2}, Lḓ/㲝/ℓ;->䆀(II)Lḓ/㲝/䆀;
    ...
    new-instance v2, L㺴/உ/ㄬ/㲧/ㄏ/உ;

    invoke-direct {v2, v0}, L㺴/உ/ㄬ/㲧/ㄏ/உ;-><init>(Ljava/util/List;)V
...
.method public static synthetic உ(Ljava/util/List;Lcom/facebook/GraphResponse;)V
    .locals 0
...
.method public static synthetic 䂻(Lcom/facebook/internal/instrument/InstrumentData;Lcom/facebook/internal/instrument/InstrumentData;)I
    .locals 0
...
.method public final declared-synchronized enable()V
    ...
    invoke-direct {v1, v0, v2}, Lcom/facebook/internal/instrument/crashreport/CrashHandler;-><init>(Ljava/lang/Thread$UncaughtExceptionHandler;Lḓ/ᓭ/㺴/ᆻ;)V
