                ...
                if (o && o.length > 0)
                    o.forEach(function (t) {
                        e.push({
                            ...
                            name: t.game_name,
                            game_des: t.game_des,
                            game_onlineUsers: t.game_onlineUsers
                        })
                    });
                else {
                                ...
                                if (r && r.length > 0)
                                    r.forEach(function (e) {
                                        e.sub_gid == o && t.push({
                                            ...
                                            name: e.game_name,
                                            game_des: e.game_des,
                                            game_onlineUsers: e.game_onlineUsers
                                        })
                                    });
                                else {
                                    ...
                                    s ? t.push({
                                        ...
                                        name: n.game_name,
                                        game_des: n.game_des,
                                        game_onlineUsers: n.game_onlineUsers
                    ...
                    if (app.UserManager().GetUserInfoConfig.game_arr.InArray(o)) {
                        ...
                        if (r)
                            n.push({
                                ...
                                name: r.game_name,
                                game_des: r.game_des,
                                game_onlineUsers: r.game_onlineUsers
                            });
                        else if (!i) {
                                        ...
                                        if (e.has_child)
                                            ...
                                            p ? (c = true,
                                                n.push({
                                                    ...
                                                    name: a.game_name,
                                                    game_des: a.game_des,
                                                    game_onlineUsers: a.game_onlineUsers
