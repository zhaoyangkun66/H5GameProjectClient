...
var o = require("../../Define/ShareDefine")
    ...
    , s = function (e) {
        ...
        return __extends(t, e),
            ...
            ,
            t.prototype.RequestDailyRegistrations = function (e, id) {
                app.HttpServerManager().SendHttpPack(r.HttpAPI.GET_DailyRegistrations, {
                    token: app.UserManager().GetUserInfo.token,
                    type: e,//0获取任务签到信息2领取签到3领取任务
                    id: id//任务id
                })
                // if (!CC_BUILD) {
                //     this.onGetDailyRegistrations({
                //         cumulativeDays: 4, //连续领取第几天
                //         isReceived: 0, //今天是否已领取 0未领取 1已领取
                //         gold: e, //领取金币大于0弹出领取奖励界面
                //         taskList: [
                //             {
                //                 id: 1,//任务id
                ...
                //                 rewardGold: 10000,
                //                 progress: 50,//进度
                //                 icon: "http://192.168.1.100:280/clientTelegram/uploads/images/taskconfig/icon1.png",
                //                 barcolor: "#5F32FF",//进度条颜色
                //                 startTime: "1726067161"//任务开始时间
                //             },
                //             {
                //                 id: 2,
                ...
                //                 rewardGold: 50000,
                //                 progress: 100,
                //                 icon: "http://192.168.1.100:280/clientTelegram/uploads/images/taskconfig/icon2.png",
                //                 barcolor: "#FBB54D",
                //                 startTime: "0"
                //             },
                //             {
                ...
                //                 rewardGold: 5000,
                //                 progress: 50,
                //                 icon: "http://192.168.1.100:280/clientTelegram/uploads/images/taskconfig/icon3.png",
                //                 barcolor: "#51D17F",
                //                 startTime: "1736057161"
                //             },
                //             {
                //                 id: 4,
                ...
                //                 rewardGold: 1000,
                //                 progress: 50,
                //                 icon: "http://192.168.1.100:280/clientTelegram/uploads/images/taskconfig/icon4.png",
                //                 barcolor: "#5F32FF",
                //                 startTime: "0"
                //             }
                //         ]
            ...
            t.prototype.RequestNewbieBonusReceive = function (e, cpf) {
