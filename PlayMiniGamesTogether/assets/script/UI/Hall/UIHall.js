        ...
        return __extends(t, e),
            ...
            t.prototype.OnClick = function (e, t) {
                if ("btn_share" == e) {
                    ...
                    cc.sys.openURL("https://t.me/share/url?url=" + encodedUrl)//+ "&text=You can easily earn TON coins by playing games, come and try it"

                    //   https://t.me/playtogetherhub_bot/playtogether

                }
                else if ("tx_icon" == e) {
                    app.HallManager().ShowHallForm(UINameDefine.UINameDefine.UIAccount)
                }
            ...
            t.prototype.RenderGameTypeTitle = function () {
                ...
                this.typeIconArr = [],
                    ...
                    a.forEach(function (n) {
                        ...
                        if (o) {
                            if (!s || l > 1) {
                                var i = app.LocalDataManager().GetConfigProperty("SysSetting", "Language2")
            ...
            t.prototype.renderAllGameType = function () {
                ...
                this.CreateGameTypeList(0, 3).active = false;
                for (var o = 1; o <= t.length; o++) {
                    let tempviewType = t[o - 1].viewType
                    this.scheduleOnce(function () {
                        e.CreateGameTypeList(o, tempviewType)
                    }, o * n.RenderDelay);
                }
                this.scheduleOnce(function () {
                    e.initSuccess = true,
            ...
            ,
            t.prototype.CreateGameTypeList = function (e, type) {
                if (type == null) {
                    type = 1
                }
                var t = cc.instantiate(this.prefabGameListItem[type]);
            ...
            t.prototype.OnSetLanguage = function () {
                for (var e = 0; e < this.typeIconArr.length; e++) {
                    var t = this.typeIconArr[e]
                        ...
                        , o = app.LocalDataManager().GetConfigProperty("SysSetting", "Language2")
