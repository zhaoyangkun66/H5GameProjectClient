            ...
            return __extends(t, e),
                t.prototype.OnLoadInit = function () {
                    ...
                    this.nodeMaintain = this.GetWndNode("weihu", t),
                        ...
                        this.label_des = this.GetWndComponent("game/label_des", cc.Label),
                        this.onlineUsers = this.GetWndComponent("game/onlineUsers/onlineUsers", cc.Label),
                        this.onlineUsers2 = this.GetWndComponent("game/onlineUsers/onlineUsers2", cc.Label),
                ...
                t.prototype.renderData = function (e) {
                    ...
                    if (t) {
                        if (this.typeicon == 4) {
                            t = t.replace("/big/", "/small/").replace("/middle/", "/small/")
                        }
                        this.renderTagView(),
                        ...
                        this.lb_name && (this.lb_name.string = e.name)
                        if (this.label_des) {
                            this.label_des.string = e.game_des
                        }
                        if (this.onlineUsers) {
                            this.onlineUsers.string = e.game_onlineUsers
                        }
                        else if (this.onlineUsers2) {
                            this.onlineUsers2.string = e.game_onlineUsers + " played"
                        }
                    } else
                ...
                t.prototype.EnterGame = function () {
                    if (this._data.gid)
                        app.FormManager().ShowForm(a.UINameDefine.UIIntoGame, this._data)
                ...
                ,
                __decorate([s.property({})], t.prototype, "typeicon", undefined),
                __decorate([c], t)
        }(o.default));
n.default = l,
    module.exports = n
