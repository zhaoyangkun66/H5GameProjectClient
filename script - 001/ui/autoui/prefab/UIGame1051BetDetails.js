            ...
            return __extends(e, t),
                ...
                e.prototype.UpdateTitle = function () {
                    var t = this.data.result.length > 1
                        , e = t ? app.i18n.t("UI_Game1051_Respin") : app.i18n.t("UI_Game1051_NormalSpin")
                ...
                e.prototype.InitTitleList = function () {
                    ...
                    for (var t = 0; t < this.data.result.length; t++) {
                        ...
                        var i = app.i18n.t("UI_Game1051_Respin") + ":" + (t + 1) + "/" + this.data.result.length
                ...
                e.prototype.initDetails = function () {
                    ...
                    this.ui.label_bet.string = app.i18n.t("HallGame_Bet_State") + "(" + i + ")",
                        ...
                        this.ui.label_size.string = app.i18n.t("UI_Game1051_BetSize") + " " + this.roomMgr.addThousandSeparator(Number(this.data.bet)),
                        this.ui.label_level.string = app.i18n.t("UI_Game1051_BetLevel") + " " + this.data.level,
                        this.UpdateTitle()
                }
                ,
                ...
                e.prototype.onTipsCallBack = function (t, e) {
                    for (var i = 0; i < this.ClickLiList.length; i++) {
                        var n = this.ClickLiList[i].node
                            ...
                            , h = app.i18n.t("UI_Game1051_BetSize") + " x " + app.i18n.t("UI_Game1051_BetLevel") + " x " + app.i18n.t("UI_Game1051_SymbolPayout") + d;
