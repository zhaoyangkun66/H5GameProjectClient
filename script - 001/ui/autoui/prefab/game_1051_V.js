            ...
            return __extends(e, t),
                e.prototype.OnCreateInit = function () {
                    ...
                    this.HDSprStrArr = [],
                        ...
                        this.TipsList[1] = app.i18n.t("UI_Game1051_TipsWinupto2500"),
                        this.TipsList[2] = app.i18n.t("UI_Game1051_Tipsx10multiplier"),
                ...
                e.prototype.updateTipIndex = function () {
                    if (this.gameStatus != h.enum_Game1051Status.GAME_ENDED && this.gameStatus != h.enum_Game1051Status.GAME_END && (!this.roomMgr.BetResultData || 2 != this.roomMgr.BetResultData.type)) {
                        ...
                        if ("btn_auto" != t)
                            if ("label_gold" != t)
                                if ("label_win" != t && "btn_history" != t) {
                                    ...
                                    if (app.GameConfigManager().GetManufacturerFiltering() && app.UserManager().GetIsOfficialPopup())
                                        return;
                                    this.gameStatus != h.enum_Game1051Status.INIT && this.gameStatus != h.enum_Game1051Status.GAME_ENDED || app.FormManager().ShowForm(h.Game1051UIName.UIGame1051Record)
                                }
                            else
