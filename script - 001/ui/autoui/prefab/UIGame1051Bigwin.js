...
function(t) {
    ...
    e.prototype.updateInfo = function() {
        ...
        0 == this.playkey ? this.bgSpAnimNode.setAnimation(0, a.Game1051BigWinName.bigwin_act, false) : 1 == this.playkey ? this.bgSpAnimNode.setAnimation(0, a.Game1051BigWinName.megawin_act, false) : 2 == this.playkey && this.bgSpAnimNode.setAnimation(0, a.Game1051BigWinName.supermegawin_act, false))
    }
    ,
