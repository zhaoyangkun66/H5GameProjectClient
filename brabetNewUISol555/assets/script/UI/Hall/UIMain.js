        ...
        return __extends(t, e),
            ...
            t.prototype.OnEnable = function () {
                app.ComTool().H5Platform() ? (this.scrollView.enabled = true,
                    ...
                    this.scrollView.node.on("scroll-ended", this.OnScrolling, this, true)) : (this.scrollView.enabled = true,
                        this.scrollView.node.on("scroll-ended", this.OnScrolling, this, true),
