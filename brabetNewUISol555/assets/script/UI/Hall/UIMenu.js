...
var o, i = require("../../../Common/Base/BaseForm"),
    ...
    c = require("../../common/room_mode_tool"),
    l = cc._decorator,
    p = l.ccclass,
    d = (l.property,
        o = cc.Node,
        ...
        function (e) {
            ...
            return __extends(t, e),
                    ...
                    if ("language" != e && "region" != e && app.ComTool().H5Platform() && this.CloseForm(),
                        ...
                        if ("newCanalOficial" == e) {
                            ...
                            if ("btn_wheel" != e) {
                                ...
                                if ("btn_game" != e)
                                    if ("btn_coupon" == e) {
                                        app.FormManager().IsFormShow(s.UINameDefine.UIWithdrawalCoupon) || app.FormManager().ShowForm(s.UINameDefine.UIWithdrawalCoupon);
                                    } else if ("withdraw" != e && "quanmindai" != e)
                                        ...
                                        if (app.UserManager().GetIsOfficialPopup())
                                            return;
                                        if (GameTypeGlobal == 2) {
                                            app.FormManager().ShowForm(s.UINameDefine.UIPromoteMainSol)
                                        }
                                        else {
                    ...
                    if (t && e) {
                        if (e == 1) {
                            ...
                            this.GetWndNode("title/icon", t).getComponent(cc.Sprite).spriteFrame = this.regionSpr[1],
                                this.GetWndNode("title/label", t).getComponent(cc.Label).string = "Chile"
                        }
                    }
                ...
                t.prototype.VisibleNode = function () {
                    ...
                    if (this.GetWndNode("left/bg/view/content/top_activity/btn_coupon")) {
                        if (app.UserManager().getIsOfficialAccount()) {
                            this.GetWndNode("left/bg/view/content/top_activity/btn_coupon").active = true
                        }
                        else {
                            this.GetWndNode("left/bg/view/content/top_activity/btn_coupon").active = false
                        }
                    }
                }
                ,
