...
var o, i = require("../../../Common/Base/UIBaseComponent")
    , a = require("../../../Common/DB/Hall/StoreManager")
    ...
    , EditBoxRegExp = require("../../../Common/Component/EditBoxRegExp")
    , RichTextCallBack = require("../../common_component/RichTextCallBack")
    , c = cc._decorator, l = c.ccclass, p = c.property, d = (o = cc.Node,
        __extends(function () {
            ...
            return __extends(t, e),
                t.prototype.OnLoadInit = function () {
                    ...
                    this.JS_Name = "UIStore",
                        ...
                        this.RegEvent(r.GameEventDefine.GET_NewbieBonusReceive, this.onGetNewbieBonusReceive)
                    ...
                    this.ShopNumEditBox.getComponent(cc.EditBox).addComponent(EditBoxRegExp.default).initRegExp(EditBoxRegExp.RegExpType.NUM_And_Zero, null, this)
                },
                t.prototype.onGetNewbieBonusReceive = function (data) {
                    if (data.code == 1) {
                        ...
                        if (data.username && data.username.length > 0) {
                            if (app.UserManager().GetUserInfo.pix_key.length < 1) {
                ...
                t.prototype.InitScrollViewData = function (e) {
                    ...
                    if (a) {
                        ...
                        r && (d = app.i18n.t("UI_Shop_USDT_TetherText")),
                            ...
                            cc.find("scrollview_content/view/content/below/richtext", this.node).getComponent(RichTextCallBack.default).setRichtextStrCallBack({
                                str: i.show_desc,
                                callBack: function (link) {
                                    app.InteractionMgr().SendWndEvent(link)
                                    app.FormManager().CloseForm(UINameDefine.UINameDefine.UIStoreAndCash)
                                }
                            }),
                        ...
                        if (GameTypeGlobal == 2 && i.activity_id == 0) {
                            h = false
                            var ChannelTemp = i
                        }
                        let BonusString = ""
                        this.CheckPercentNode.active = h,
                            ...
                            a.goods.forEach(function (e, indexGoods) {
                                ...
                                {
                                    let maskBouns = cc.find("maskBouns", n)
                                    maskBouns.active = false
                                    // if (GameTypeGlobal == 2) {
                                    //     if (maskBouns) {
                                    //         if (ChannelTemp.send_bonus_ratio > 0) {//&& indexGoods > 0
                                    //             maskBouns.active = true
                                    //         } else {
                                    //             maskBouns.active = false
                                    //         }
                                    //         cc.find("lb_num", maskBouns).getComponent(cc.Label).string = "+" + (ChannelTemp.send_bonus_ratio * e) + app.i18n.t("UI_Code_Bonus")
                                    //     }
                                    // }
                                    // else 
                                    if (GameTypeGlobal == 3) {
                                        BonusString = app.i18n.t("UI_Code_Bonus")
                                    }
                                }
                                ...
                                var p = cc.find("mask", n)
                                    ...
                                    , u = 0;
                                if (GameTypeGlobal == 2) {
                                    l.send_amount > 0 && h && (u = Number(l.send_amount))
                                }
                                else {
                                    c > 0 && h && (u = Number(e) * c / 100)
                                }
                                if (l) {
                                ...
                                u > 0 ? (d.string = "+" + u + a.multiple_unit + BonusString,
                ...
                t.prototype.EditBoxGoldNumEnd = function (e) {
                    //  e.string = Math.floor(e.string)
                    //  this.ShopNumEditBox.getComponent(cc.EditBox).string = Math.floor(this.ShopNumEditBox.getComponent(cc.EditBox).string)
                ...
                t.prototype.SetShopNumNodeData = function (e) {
                    ...
                    if (this.lblExtra.getComponent(cc.Label).string = "",
                        ...
                        if (GameTypeGlobal == 2) {
                            // for (let index = 0; index < t.send_list.length; index++) {
                            //     if (e >= t.send_list[index].amount) {
                            //         u = t.send_list[index].sendamount
                            //     }
                            // }
                            u = n.send_amount
                        }
                ...
                t.prototype.showRechargeInfoForm = function () {
                    ...
                    if (this.isCheckInportShopNum() && "" == this.ShopNumEditBox.getComponent(cc.EditBox).string)
                        ...
                        if (t > Number(e.max_amount))
                            ...
                            // if (GameTypeGlobal == 2) {
                            //     d.join_activity = app.StoreManager().GetChannel(this._SelectChannelID).activity_id
                            //     d.send_percent = app.StoreManager().GetChannel(this._SelectChannelID).send_bonus_ratio
                            // }
