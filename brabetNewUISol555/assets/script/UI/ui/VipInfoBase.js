const { FacebookUtils } = require("parse");
        ...
        return __extends(t, e),
            ...
            t.prototype.OnClick = function (e, t, n) {
                if ("btn_Detail" == e) {
                    ...
                    t.parent.getChildByName("btn_Detail").active = true
                }
                else if ("btn_left" == e) {
                    if (!this.isPlayAnim) {
                        var n = this.showLv - 1
                ...
                else if ("btn_grade" != e && "btn_day" != e && "btn_week" != e && "btn_month" != e)
                ...
                if (this.getListInfo = e.list,
                    ...
                    this.getListInfo.forEach(function (e, n) {
                        ...
                        o || ((o = cc.instantiate(a)).parent = t.contentNode1),
                            t.renderLvGetInfo(e.id, rootdata),
                            o.active = true
                    }),
            ...
            ,
            t.prototype.renderLvGetInfo = function (e, rootdata) {
                ...
                if (null == t || n < 0)
                    ...
                    if (GameTypeGlobal == 2) {
                        (d = p.children[1]).getComponent(cc.Sprite).spriteFrame = this.GoldBg[r],
                            (h = this.GetWndNode("icon_red", d)).active = 0 == t.day;
                        var f = this.GetWndNode("btn_day", d);
                        f.active = 0 == t.day,
                            f.getComponent(cc.Button).enabled = 0 == t.day,
                            this.setNumLblColor(this.GetWndNode("btn_mask", f), n),
                            this.GetWndNode("Uncompleted", d).active = s,
                            (_ = this.GetWndNode("Received", d)).active = !s && this.getSelfVip(e) && 0 != t.day,
                            _.active && (this.GetWndComponent("label_tips", cc.Label, _).string = this.getDayDayReceived()),
                            (m = this.GetWndNode("state_lock", d)).active = !s && !this.getSelfVip(e) && 0 != t.day,
                            this.setLVNodeView(e, d, f, n),
                            this.GetWndComponent("label_num", cc.Label, d).string = this.formatScore(t.day_gold)

                        this.GetWndComponent("btn_Detail/bg2", cc.Sprite, d).spriteFrame = this.GoldBg[r]
                        this.GetWndComponent("btn_Detail/bg", cc.Sprite, d).spriteFrame = this.GoldBg[r]
                        this.GetWndComponent("btn_Detail/day_recharge", cc.Label, d).string = rootdata.day_recharge + "/" + t.day_limitpay
                        this.GetWndComponent("btn_Detail/day_rechargeBar", cc.ProgressBar, d).progress = rootdata.day_recharge / t.day_limitpay
                        this.GetWndComponent("btn_Detail/day_bets", cc.Label, d).string = rootdata.day_bets + "/" + t.day_limitbet
                        this.GetWndComponent("btn_Detail/day_betsBar", cc.ProgressBar, d).progress = rootdata.day_bets / t.day_limitbet
                    }
                    ...
                    if (GameTypeGlobal == 2) {
                        this.GetWndComponent("btn_Detail/bg2", cc.Sprite, d).spriteFrame = this.GoldBg[r]
                        this.GetWndComponent("btn_Detail/bg", cc.Sprite, d).spriteFrame = this.GoldBg[r]
                        this.GetWndComponent("btn_Detail/day_recharge", cc.Label, d).string = rootdata.week_recharge + "/" + t.week_limitpay
                        this.GetWndComponent("btn_Detail/day_rechargeBar", cc.ProgressBar, d).progress = rootdata.week_recharge / t.week_limitpay
                        this.GetWndComponent("btn_Detail/day_bets", cc.Label, d).string = rootdata.week_bets + "/" + t.week_limitbet
                        this.GetWndComponent("btn_Detail/day_betsBar", cc.ProgressBar, d).progress = rootdata.week_bets / t.week_limitbet
                    }
                    (d = p.children[3]).getComponent(cc.Sprite).spriteFrame = this.GoldBg[r],
                    ...
                    if (GameTypeGlobal == 2) {
                        this.GetWndComponent("btn_Detail/bg2", cc.Sprite, d).spriteFrame = this.GoldBg[r]
                        this.GetWndComponent("btn_Detail/bg", cc.Sprite, d).spriteFrame = this.GoldBg[r]
                        this.GetWndComponent("btn_Detail/day_recharge", cc.Label, d).string = rootdata.month_recharge + "/" + t.month_limitpay
                        this.GetWndComponent("btn_Detail/day_rechargeBar", cc.ProgressBar, d).progress = rootdata.month_recharge / t.month_limitpay
                        this.GetWndComponent("btn_Detail/day_bets", cc.Label, d).string = rootdata.month_bets + "/" + t.month_limitbet
                        this.GetWndComponent("btn_Detail/day_betsBar", cc.ProgressBar, d).progress = rootdata.month_bets / t.month_limitbet
                    }
            ...
            t.prototype.renderClickButton = function (e, t) {
                if (GameTypeGlobal == 2) {
                    ...
                    var a = this.GetWndNode("btn_grade", i)
                        , r = "";
                    if (2 == e) {
                        a = this.GetWndNode("btn_day", i)
                        r = this.getDayDayReceived();
                    }
                    else if (3 == e) {
                        a = this.GetWndNode("btn_week", i)
                        r = this.getWeekReceived();
                    }
                    else if (4 == e) {
                        a = this.GetWndNode("btn_month", i)
            ...
            ,
            t.prototype.getDayDayReceived = function () {
                return 1 + app.i18n.t("UI_Vip_DaysLater")
            }
            ,
