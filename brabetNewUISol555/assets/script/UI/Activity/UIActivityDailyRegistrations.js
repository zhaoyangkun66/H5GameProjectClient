        ...
        return __extends(t, e),
            ...
            t.prototype.onGetDailyRegistrations = function (data) {
                ...
                if (GameTypeGlobal == 3) {
                    ...
                    this.lblGold[0].string = data.signaward[0]
                    this.lblGold[1].string = data.signaward[1]
                    this.lblGold[2].string = data.signaward[2]
                    this.lblGold[3].string = data.signaward[3]
                    this.lblGold[4].string = data.signaward[4]
                    this.lblGold[5].string = data.signaward[5]
                    this.lblGold[6].string = data.signaward[6]
                    this.lbl[2].string = app.i18n.t("UI.UIActivityDailyRegistrations4") + app.ScoreUtil().toFixed(data.recharge) + "/" + data.limitpay
                    this.lbl[3].string = app.i18n.t("UI.UIActivityDailyRegistrations5") + app.ScoreUtil().toFixed(data.bet) + "/" + data.limitbet
                }
                else {
