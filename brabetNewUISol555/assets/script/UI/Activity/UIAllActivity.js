    ...
    , p = function (e) {
        ...
        return __extends(t, e),
                ...
                if (e) {
                    ...
                    for (let i = 0; i < n.length; i++) {
                        ...
                        if (u && u.switch) {
                            ...
                            else if (l.act_id == a.ActivityType.subordinate_recharge_gift) {
                                RedDotIDArr.push(a.RedDotEnum.spread_wayActivity)
                            }
            ...
            t.prototype.ActivityItemCallBack = function (e, t) {
                ...
                else if (GameTypeGlobal == 2 && t == a.ActivityType.subordinate_recharge_gift) {
                    if (!app.UserManager().GetIsOfficialPopup())
                        app.FormManager().ShowForm(r.UINameDefine.UIActivityPromote)
                }
                else {
