        ...
        return __extends(t, e),
            ...
            t.prototype.OnRecharge = function (data) {
                ...
                for (var n = 0; n < e.length; n++) {
                    ...
                    if (o.type == 1) {
                        i.getChildByName("type").getComponent(cc.Label).string = app.i18n.t("UI.MakeMoney_3_MyCommission_10") //"jogo" 
                    }
                    else if (o.type == 2) {
                        i.getChildByName("type").getComponent(cc.Label).string = app.i18n.t("UI_Top_Wallet")//UI_Top_Wallet  "depósito"
                    }
                    else if (o.type == 3) {
                        i.getChildByName("type").getComponent(cc.Label).string = app.i18n.t("UI.UIAccountBalanceChangeRecord2")//"retirar"
                    }
                    else if (o.type == 4) {
                        i.getChildByName("type").getComponent(cc.Label).string = app.i18n.t("UI_Code_Bonus") //"bônus"
                    }
