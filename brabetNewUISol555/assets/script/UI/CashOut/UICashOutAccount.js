    ...
    , u = function (e) {
        ...
        return __extends(t, e),
            ...
            t.prototype.OnClick = function (e, t, n) {
                ...
                else if ("Cuenta Corriente" == e || "Cuenta RUT" == e || "Cuenta Ahorro" == e || "Cuenta Vista" == e) {
            ...
            t.prototype.setBindBankUserData = function () {
                ...
                if (e) {
                    ...
                    //  e.withdrawType: channelID, //1巴西2智利
                    ...
                    this.ColombiaIdType_Node.getChildByName("editbox").getComponent(cc.EditBox).string = "RUT"
                    ...
                    this.BankAccountType_Node.getChildByName("editbox").getComponent(cc.EditBox).string = "Cuenta Corriente"
                ...
                if (app.CashOutManager().GetCurrentCashOutType() != a.CashOutType.USDT) {
...

                    {
                        ...
                        var c = {
                            ...
                            withdrawType: channelIDGlobal, //1巴西2智利
