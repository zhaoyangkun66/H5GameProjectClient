            ...
            if (e) {
                ...
                if (e >= 10101 && e < 10108) {
                    ...
                    if (app.UserManager().GetIsOfficialPopup())
                        return;
                    if (GameTypeGlobal == 2) {
                        app.FormManager().ShowForm(l.UINameDefine.UIPromoteMainSol)
                    }
                    else {
                    ...
                    if (GameTypeGlobal == 2) {
                        if (!app.UserManager().GetIsOfficialPopup())
                            app.FormManager().ShowForm(l.UINameDefine.UIActivityPromote);
                    }
                    else {
                    ...
                    app.FormManager().ShowForm(l.UINameDefine.UIActivity, s.ActivityType.LossRebate);
                else if (22120 == e)
                    ...
                    app.FormManager().ShowForm(l.UINameDefine.UIActivityLossRebate);
                else if (100002 == e) {
                    // if (!app.UserManager().GetIsOfficialPopup())
                    app.FormManager().ShowForm(l.UINameDefine.UIActivityNewbieBonus);
                }
                else if (100003 == e) {
                    // if (!app.UserManager().GetIsOfficialPopup())
                    app.FormManager().ShowForm(l.UINameDefine.UIActivityLuckyLottery);
                }
                else if (22137 == e)
