...
var l = function (e) {
    ...
    return __extends(t, e),
        t.prototype.Init = function () {
            ...
            app.HttpServerManager().RegNetPack(a.HttpAPI.GET_USER_BalanceChangeRecords, this.onGetUserBalanceChangeRecords, this)
            app.HttpServerManager().RegNetPack(a.HttpAPI.modifywithdrawpass, this.onModifywithdrawpass, this)
        }
        ,
        ...
        ,
        t.prototype.onGetUserBalanceChangeRecords = function (e) {
            app.Client.OnEvent(i.GameEventDefine.GET_USER_BalanceChangeRecords, e)
        }
        ,
        ...
        t.prototype.RequestUserBalanceChangeRecords = function (e, t, n, o, i) {
            ...
            o && (r.start_date = o),
                i && (r.end_date = i),
                app.HttpServerManager().SendHttpPack(a.HttpAPI.GET_USER_BalanceChangeRecords, r)
        }
        ,
        ...
        t.prototype.onGetUserWallet = function (e) {
            ...
            this.UserWallet = e,
                ...
                this.UserInfo.saldo = Number(e.saldo),
                app.Client.OnEvent(i.GameEventDefine.GET_USER_WALLET)
        }
        ,
        t.prototype.RequstModifywithdrawpass = function (withdrawalPassword) {
            app.HttpServerManager().SendHttpPack(a.HttpAPI.modifywithdrawpass, {
                token: app.UserManager().GetUserInfo.token,
                withdrawalPassword: withdrawalPassword
            })
        }
        ,
        t.prototype.onModifywithdrawpass = function (e, t) {
            app.Client.OnEvent(i.GameEventDefine.modifywithdrawpass, t.withdrawalPassword)
        }
        ,
