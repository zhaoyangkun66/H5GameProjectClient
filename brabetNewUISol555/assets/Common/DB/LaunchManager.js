        ...
        return __extends(t, e),
            t.prototype.Init = function () {
                this.JS_Name = "LaunchManager",
                    ...
                    app.HttpServerManager().RegNetPack(a.HttpAPI.GET_channelList, this.OnGameChannelList, this),
            ...
            ,
            t.prototype.OnGameChannelList = function (array) {
                app.ClientConfigManager().GetClientConfig.TempChannelList = array
                channelIDNewbieBonusShow = false
                for (let index = 0; index < array.length; index++) {
                    if (array[index] == app.ClientConfigManager().GetClientConfig.channel_id) {
                        channelIDNewbieBonusShow = true
                    }
                }
                // app.Client.OnEvent(i.GameEventDefine.GET_channelList)
            }
            ,
