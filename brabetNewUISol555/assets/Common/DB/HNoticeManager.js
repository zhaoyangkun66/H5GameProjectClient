    ...
    , c = function (e) {
        ...
        return __extends(t, e),
            ...
            t.prototype.Init = function () {
                ...
                app.HttpServerManager().RegNetPack(a.HttpAPI.GET_GongGao_LIST, this.onGetGongGaoListData, this)
                app.HttpServerManager().RegNetPack(a.HttpAPI.GetGongGaoDetail, this.onGetGongGaoDetail, this)
            }
            ,
            ...
            t.prototype.onGetNoticeListData = function (e) {
                ...
                if (app.FormManager().IsFormShow(s.UINameDefine.UIHall)) {
                    var t = true;
                    this.NoticeListDataResult && this.NoticeListDataResult.length > 0 && this.GetOpenNotice && (t = false,
            ...
            t.prototype.onGetGongGaoListData = function (e) {
                app.Client.OnEvent(i.GameEventDefine.GET_GongGao_LIST, e)
            },
            t.prototype.onGetGongGaoDetail = function (e, t) {
                app.Client.OnEvent(i.GameEventDefine.GetGongGaoDetail, t)
            },
            ...
            t.prototype.RequestGetGongGaoList = function () {
                if (!CC_BUILD) {
                    this.onGetGongGaoListData([
                        {
                            "id": 565,//公告id
                            "title": "title",//标题
                            "content": "Bem-vindo ao <color=#f9de06>SOL555.COM</color>, cofre, tudo o que você deseja está aqui",
                            "create_time": "2024-08-21 10:59:40",
                            "status": 0 // 0:未读 1:已读
                        },
                        {
                            "id": 566,
                            "title": "title2",
                            "content": "Clique para entrar no canal e receber bônus grátis <on click='handler' param='https://t.me/SOL555com'>https://t.me/SOL555com</on> Participe de atividades em grupo, participe de sorteios em grupo, brindes diversos <on click='handler' param='https://t.me/SOL555com'>https://t.me/SOL555vip</on>",
                            "create_time": "2024-01-21 10:59:40",
                            "status": 0
                        }
                    ])
                }
                else {
                    app.HttpServerManager().SendHttpPack(a.HttpAPI.GET_GongGao_LIST, {
                        token: app.UserManager().GetUserInfo.token
                    })
                }
            },
            t.prototype.RequestGetGongGaoDetail = function (id) {
                if (!CC_BUILD) {
                    this.onGetGongGaoDetail(null, {
                        token: app.UserManager().GetUserInfo.token,
                        id: id
                    })
                }
                else {
                    app.HttpServerManager().SendHttpPack(a.HttpAPI.GetGongGaoDetail, {
                        token: app.UserManager().GetUserInfo.token,
                        id: id
                    })
                }
