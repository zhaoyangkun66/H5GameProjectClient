    ...
    , r = function (e) {
        ...
        return __extends(t, e),
            ...
            t.prototype.OnGameList = function (e, t) {
                if (e) {
                    if (isgoServer) {
                        ...
                        //             "type_id": 9,
                        //             "type_name": "In-House",
                        //             "icon": "http://192.168.1.100:280/client/uploads/images/game_lobby_tye/Inhouse.png",
                        ...
                        //                             "game_sort": 10010,
                        //                             "sub_game_sort": 10010,
                        //                             "icon": "http://192.168.1.100:280/client2048betChile/uploads/gameicon/inhouse/Fortune_Ox.png",
                        //                             "fury_icon": "http://192.168.1.100:280/client2048betChile/uploads/gameicon/inhouse/Fortune_Ox.png"
                        //                         }
                        //                     ]
                        //                 }
                        //             ],
            ...
            t.prototype.RequestGameConfig = function () {
                ...
                app.HttpServerManager().SendHttpPack(o.HttpAPI.GET_channelList, {})
            ...
            t.prototype.GameBetAmountLimit = function (e, t) {
                var n = {
                    min: 0,
                    max: 0
                }
                //   , o = this.GetGameInfoByGid(e);
                // if (o)
                //     for (var i = 0; i < o.way_bet_gold.length; i++) {
                //         var a = o.way_bet_gold[i];
                //         a.way_id == t && (n = {
                //             min: Number(a.min_bet_gold),
                //             max: Number(a.max_bet_gold)
                //         })
                //     }
                // else
                //     this.ErrLog("GameBetSizeLimit2 fail gid: ", e);
                return n
            }
            ,
