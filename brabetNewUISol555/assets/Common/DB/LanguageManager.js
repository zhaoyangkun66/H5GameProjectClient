    ...
    , s = function (e) {
        ...
        return __extends(t, e),
            ...
            t.prototype.SetLanguage = function (e) {
                app.i18n.selectLang(e) && (app.LocalDataManager().SetConfigProperty("SysSetting"+ GameTypeGlobal, "Language", e),
                    app.Client.OnEvent(i.GameEventDefine.HALL_Language))
            },
            t.prototype.SetSelectRegion = function (e) {
                app.LocalDataManager().SetConfigProperty("SysSetting"+ GameTypeGlobal, "LocalSelectRegion4" + channelIDGlobal, e)
            }
            ,
            ...
            t.prototype.GetLocalLanguage = function (e) {
                return app.LocalDataManager().GetConfigProperty("SysSetting"+ GameTypeGlobal, "Language") || (e ? r.default.enus : null)
            },
            t.prototype.GetLocalSelectRegion = function (e) {
                return app.LocalDataManager().GetConfigProperty("SysSetting"+ GameTypeGlobal, "LocalSelectRegion4" + channelIDGlobal)
            }
            ,
