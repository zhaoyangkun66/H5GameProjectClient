    ...
    return __extends(t, e),
        t.prototype.Init = function () {
            this.JS_Name = "LoginManager",
                ...
                app.HttpServerManager().RegNetPack(r.HttpAPI.home_heartbeat, this.OnHomeHeartbeat, this),
        ...
        t.prototype.GetDeviceID = function () {
            // if (visitorIdDeviceIdGlobal) {
            //     return visitorIdDeviceIdGlobal
            // }
        ...
        t.prototype.SetUserInfoAndLoginGS = function (e) {
            ...
            if (e.code != l.ReqFailCode.IP_DEVICE_LIMIT) {
                ...
                if (isgoServer) {
                    ...
                    if (GameTypeGlobal == 3) {
                        if (e.bankAccountType == 0) {
                            e.bankAccountType = "Cuenta Corriente"
                        }
                        else if (e.bankAccountType == 1) {
                            e.bankAccountType = "Cuenta Ahorro"
                        }
                        else if (e.bankAccountType == 2) {
                            e.bankAccountType = "Cuenta Vista"
                        }
                        else if (e.bankAccountType == 3) {
                            e.bankAccountType = "Cuenta RUT"
                        }
                        if (e.colombia_idType != "RUT" && e.colombia_idType != "RUN" && e.colombia_idType != "PAS" && e.colombia_idType != "CE") {
                            e.colombia_idType = ""
                        }
                    }
                    // e.total_recharge=1
        ...
        t.prototype.getUserLoginCode = function () {
            if (channelIDGlobal == 2) {
                return app.LocalDataManager().GetConfigObject("loginCode" + channelIDGlobal) || {
                    code: "56",
                    mark: "",
                    nation: "Chile",
                    phone_account: "",
        ...
        ,
        t.prototype.RequestHomeHeartbeat = function () {
            if (app.UserManager().GetUserInfo && app.UserManager().GetUserInfo.token) {
                var o = {
                    token: app.UserManager().GetUserInfo.token,
                    type: this.heartbeatType
                };
                app.HttpServerManager().SendHttpPack(r.HttpAPI.home_heartbeat, o)
            }
        }
        ,
        t.prototype.OnHomeHeartbeat = function (e) {
            //  app.Client.OnEvent(a.GameEventDefine.home_heartbeat, e)
        }
        ,
        t.prototype.setUserLoginCode = function (e) {
            app.LocalDataManager().SetConfigObject("loginCode" + channelIDGlobal, e)
        }
        ,
