    ...
    return __extends(t, e),
        ...
        t.prototype.RequestTx = function (e) {
            var t = {
                ...
                amount: e.amount,
                is_usdt: e.is_usdt,
                withdrawalPassword: e.withdrawalPassword
            };
        ...
        t.prototype.RequstBindBankAccount = function (e) {
            if (GameTypeGlobal == 3) {
                if (e.bankAccountType == "Cuenta Corriente") {
                    e.bankAccountType = 0
                }
                else if (e.bankAccountType == "Cuenta Ahorro") {
                    e.bankAccountType = 1
                }
                else if (e.bankAccountType == "Cuenta Vista") {
                    e.bankAccountType = 2
                }
                else if (e.bankAccountType == "Cuenta RUT") {
                    e.bankAccountType = 3
                }
            }
        ...
        t.prototype.onBindBankAccount = function (e, t) {
            if (GameTypeGlobal == 3) {
                if (t.bankAccountType == 0) {
                    t.bankAccountType = "Cuenta Corriente"
                }
                else if (t.bankAccountType == 1) {
                    t.bankAccountType = "Cuenta Ahorro"
                }
                else if (t.bankAccountType == 2) {
                    t.bankAccountType = "Cuenta Vista"
                }
                else if (t.bankAccountType == 3) {
                    t.bankAccountType = "Cuenta RUT"
                }
            }
