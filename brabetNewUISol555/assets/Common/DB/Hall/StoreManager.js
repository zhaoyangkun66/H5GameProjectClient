...
var l = function (e) {
    ...
    return __extends(t, e),
            ...
            if (isgoServer) {
                ...
                for (const key in e) {
                    for (const key2 in e[key].channel_list) {
                        ...
                        // if (!e[key].channel_list[key2].send_list) {
                        //     e[key].channel_list[key2].send_list = e[key].send_list
                        // }
                        // e[key].channel_list[key2].act_send = [
                        //     {
                        //         "amount": 10,
                        //         "send_percent": 100,
                        //         "activity_info": {
        ...
        t.prototype.onGoodsPay = function (e, t) {
            ...
            else if (e.code == 20144) {
                if (GameTypeGlobal == 3) {
                    app.FormManager().ShowForm(c.UINameDefine.UIActivityNewbieBonusGetChile, 1);
                }
                else {
                    app.FormManager().ShowForm(c.UINameDefine.UIActivityNewbieBonusGet, 1);
                }
            }
            else {
        ...
        t.prototype.ShowStoreUI = function (e) {
            if (undefined === e && (e = null),
                ...
                if (GameTypeGlobal == 2) {
                    if (e.ShowType == s.WIN_TYPE.CASHOUT) {
