    ...
    , h = function (e) {
        ...
        return __extends(t, e),
            ...
            t.prototype.onFaqList = function (e) {
                if (isgoServer) {
                    let xxx = require("Http_getFaqList")
            ...
            t.prototype.EnterGame = function (e, t) {
                if (app.EventTrackManager().LogEvent(p.default.CLICK_ENTER_GAME),
                    ...
                    if (app.ExternGameManager().IsGameDown() && app.UserManager().GetUserInfo.gold <= 0)
                        ...
                        var i = app.ExternGameManager().GetExternGameInfoOrSubGameInfo(e, t);
                        if (null != i && null != i.least_gold)
                            if ((app.UserManager().GetUserInfo.gold < Number(i.least_gold))) {
                                app.ExternGameManager().OnConfirm("SC_LessThanChips", i.least_gold);
                                return;
                            }
