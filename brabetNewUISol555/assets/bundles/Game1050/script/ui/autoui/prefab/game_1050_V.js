        ...
        function (t) {
            ...
            return __extends(e, t),
                ...
                e.prototype.ReplaceEndAnimSpr = function () {
                    ...
                    for (var n = 0; n < t.length; n++) {
                        ...
                        r >= 1 && r <= 3 ? a = this.LeftParent : r >= 4 && r <= 6 ? a = this.CenterParent : r >= 7 && (a = this.RightParent),
                            i >= 3 && (i = 0),
                            this.ReplayLuckPropSwitch ? (this.roomMgr.bundleloadres(a.children[i + 6], this.HDSprStrArr[o])) :
                                (this.roomMgr.bundleloadres(a.children[i + 6], this.HDSprStrArr[a.children[i + 6].myprop]),
                ...
                e.prototype.PlayAwardSingleLine = function (t, e) {
                    if (t) {
                        ...
                        for (var i = this.Award9AnimArray[t.roll - 1], n = 0; n < i.length; n++) {
                            ...
                            // this.roomMgr.bundleloadres(this.EndSprNodeList2[o], null)
                            ...
                            if ("label_gold" != t)
                                if ("label_win" != t && "btn_history" != t) {
                                    ...
                                    if (app.GameConfigManager().GetManufacturerFiltering() && app.UserManager().GetIsOfficialPopup())
                                        return;
                                    // if (!CC_BUILD) {
                                    this.gameStatus != h.enum_Game1050Status.INIT && this.gameStatus != h.enum_Game1050Status.GAME_ENDED || app.FormManager().ShowForm(h.Game1050UIName.UIGame1050Daily)
                                    //  }
                                }
                            else
                ...
                e.prototype.OnClose = function () {
                    ...
                    this.GetWndComponent("nodeLabel/label", cc.Label, this.Node_Tips).string = ""
                }
                ,
