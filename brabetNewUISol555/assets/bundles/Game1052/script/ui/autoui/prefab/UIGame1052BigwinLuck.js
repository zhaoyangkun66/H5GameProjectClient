        ...
        function (t) {
            ...
            return __extends(e, t),
                e.prototype.OnCreateInit = function () {
                    this.JS_Name = "UIGame1052BigwinLuck",
                ...
                e.prototype.OnShow = function () {
                    ...
                    "pt-pt" == i ? n = "Pu" : "es-es" == i ? n = "Es" : "id-id" == i && (n = "Id"),
                        ...
                        this.new_gold = t[1],
                        this.nowShow = t[2],
                        // this.bgSpAnimNode.setAnimation(0, a.Game1052BigWinName.bigwin_act, false),

                        this.unscheduleAllCallbacks(),
                        this.phase1Target = 35 * this.roomMgr.BetResultData.bet_gold,
                        this.phase2Target = 50 * this.roomMgr.BetResultData.bet_gold,
                        this.updateInfo(),
                        app.ComUtil().PlayAnim(this.node, "bigwin_act_lightLuck"),
                ...
                e.prototype.onCloseSend = function () {
                    app.ComUtil().PlayAnim(this.node, "bigwin_waitLuck"),
                        this.IsEnd = true,
                        //this.OnSendEndEvent(),
                        this.unscheduleAllCallbacks()
                }
