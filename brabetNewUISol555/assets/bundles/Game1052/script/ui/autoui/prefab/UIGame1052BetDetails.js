...
var n = require("../../../../../../Common/Base/BaseForm")
    ...
    , a = require("../../autoui/prefab/auto_UIGame1052BetDetails")
    , r = cc._decorator
    , s = r.ccclass
    , l = r.menu
    , p = (r.property,
        function (t) {
            ...
            return __extends(e, t),
                e.prototype.OnCreateInit = function () {
                    this.JS_Name = "UIGame1052BetDetails"
                }
                ,
                e.prototype.OnLoad = function () {
                    this.ui = this.node.addComponent(a.default),
                        ...
                        this.PayoutList = this.GetWndNode("bet_details/scrollview/view/content/content");
                    var e = "atlas/prop/";
                    this.HDSprStrArr = [],
                        this.HDSprStrArr[o.GameProp.NullBox] = null,
                        this.HDSprStrArr[o.GameProp.Bamboo] = e + "h1_coins",
                        this.HDSprStrArr[o.GameProp.Peach] = e + "h2_ribbon",
                        this.HDSprStrArr[o.GameProp.PurpleDiamonds] = e + "h3_firecracker",
                        this.HDSprStrArr[o.GameProp.Weapon] = e + "h4_lantern",
                        this.HDSprStrArr[o.GameProp.LuckyBag] = e + "h5_angbao",
                        this.HDSprStrArr[o.GameProp.Yupei] = e + "h6_ingot",
                        this.HDSprStrArr[o.GameProp.Omnipotence] = e + "prop_wild",
                        ...
                        this.Award9AnimSpr = [],
                        this.Award9AnimSpr.push(this.GetWndNode("bet_details/scrollview/view/content/game/game/line/prop_l2")),
                        this.Award9AnimSpr.push(this.GetWndNode("bet_details/scrollview/view/content/game/game/line/prop_l1")),
                        this.Award9AnimSpr.push(this.GetWndNode("bet_details/scrollview/view/content/game/game/line/prop_l3")),
                        this.Award9AnimSpr.push(this.GetWndNode("bet_details/scrollview/view/content/game/game/line/prop_c2")),
                        this.Award9AnimSpr.push(this.GetWndNode("bet_details/scrollview/view/content/game/game/line/prop_c1")),
                        this.Award9AnimSpr.push(this.GetWndNode("bet_details/scrollview/view/content/game/game/line/prop_c3")),
                        this.Award9AnimSpr.push(this.GetWndNode("bet_details/scrollview/view/content/game/game/line/prop_r2")),
                        this.Award9AnimSpr.push(this.GetWndNode("bet_details/scrollview/view/content/game/game/line/prop_r1")),
                        this.Award9AnimSpr.push(this.GetWndNode("bet_details/scrollview/view/content/game/game/line/prop_r3")),
                        ...
                        this.li_respin = this.GetWndNode("bet_details/scrollview/view/content/li_respin"),
                        this.li_multiplier = this.GetWndNode("bet_details/scrollview/view/content/li_multiplier"),
                        this.li_no = this.GetWndNode("bet_details/scrollview/view/content/li_no"),
                        this.li_line = this.GetWndNode("bet_details/scrollview/view/content/li_line"),
                    ...
                    this.multipleBigParentNode = this.GetWndNode("bet_details/scrollview/view/content/game/prop_multipleBig")
                    this.multipleParentNode = this.GetWndNode("bet_details/scrollview/view/content/game/prop_multiple")
                    this.multipleBigParent = this.GetWndNode("bet_details/scrollview/view/content/game/prop_multipleBig/prop_multipleBig/spr_node1")
                    this.multipleParent = this.GetWndNode("bet_details/scrollview/view/content/game/prop_multiple/prop_multiple/spr_node1")
                    this.ui_reel_bg = this.GetWndNode("bet_details/scrollview/view/content/game/game/ui_reel_bg")
                    this.bns_reel_bg = this.GetWndNode("bet_details/scrollview/view/content/game/game/bns_reel_bg")
                }
                ,
                ...
                e.prototype.initDetails = function () {
                    ...
                    this.ui.label_bet.string = app.i18n.t("HallGame_Bet_State") + "(" + i + ")",
                        ...
                        this.ui.label_balance.string = app.i18n.t("UI_Game1051_balance") + "(" + i + ")",
                ...
                e.prototype.initDetailsPropList = function () {
                    ...
                    let mypropMultiple = this.data.result[this.currentIdx].multiple
                    if (mypropMultiple.length <= 2) {
                        for (let index = 0; index < mypropMultiple.length; index++) {
                            let spr_prop = this.multipleParent.getChildByName("spr_prop" + (index + 1))
                            spr_prop.active = true
                            this.roomMgr.bundleloadres(spr_prop.getChildByName("spr_prop"), this.multipleSprStrArr[mypropMultiple[index]])
                        }
                        for (let index = mypropMultiple.length; index < 2; index++) {
                            let spr_prop = this.multipleParent.getChildByName("spr_prop" + (index + 1))
                            spr_prop.active = false
                        }
                        this.multipleBigParentNode.active = false
                        this.multipleParentNode.active = true
                        this.ui_reel_bg.active = true
                        this.bns_reel_bg.active = false
                    }
                    else {
                        for (let index = 0; index < mypropMultiple.length; index++) {
                            let spr_prop = this.multipleBigParent.getChildByName("spr_prop" + (index + 1))
                            spr_prop.active = true
                            this.roomMgr.bundleloadres(spr_prop.getChildByName("spr_prop"), this.multipleSprStrArr[mypropMultiple[index]])
                        }
                        ...
                        this.multipleBigParentNode.active = true
                        this.multipleParentNode.active = false
                        this.ui_reel_bg.active = false
                        this.bns_reel_bg.active = true
                    }
                    ...
                    // }
                    this.PropList = this.data.result[this.currentIdx].props
                    this.PropWinArr = this.data.result[this.currentIdx].win_arrs
                ...
                ,
                __decorate([s, l("UI/prefab/UIGame1052BetDetails")], e)
        }(n.default));
i.default = p,
    module.exports = i
