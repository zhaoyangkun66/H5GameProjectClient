    ...
    , m = function (t) {
        ...
        return __extends(e, t),
            ...
            e.prototype.onGameOver = function (t) {
                if (t.type == 1) {
                    app.UserManager().GetUserInfo.gold = app.UserManager().GetUserInfo.gold + t.gold//t.bets_gold
                }
                else if (t.type == 2) {
                    app.UserManager().GetUserInfo.gold = app.UserManager().GetUserInfo.gold - t.gold//t.bet_gold
                }
                var e = this
                    , n = Number(t.gold);
